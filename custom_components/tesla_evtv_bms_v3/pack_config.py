"""Tesla module pack calculations for 48V Sunny Island systems."""

from __future__ import annotations

# Model S/X 5.2 kWh module — 6s cell groups, ~22.2 V nominal per module
TESLA_MODULE_KWH = 5.2
TESLA_MODULE_CELLS = 6
TESLA_MODULE_NOMINAL_VOLTS = 22.2

# 36 Tesla modules as 2S18P on a 48 V Sunny Island 6048 (~187 kWh, ~44 V nominal)
...
# Sunny Island 6048 DC limits
DEFAULT_CHARGE_CURRENT = 100.0
DEFAULT_DISCHARGE_CURRENT = 100.0
...
def compute_pack_settings(
    ...
    """Derive pack and SMA voltage limits from Tesla module layout."""
    ...
    discharge_voltage = max(SMA_MIN_BUS_VOLTS, min(SMA_MAX_DISCHARGE_LIMIT, discharge_voltage))
