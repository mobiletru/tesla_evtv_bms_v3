...
export WEBBOX_ENABLED="$(bashio::config webbox_enabled)"
export WEBBOX_MODE="$(bashio::config webbox_mode)"
export WEBBOX_HOST="$(bashio::config webbox_host)"
export WEBBOX_PORT="$(bashio::config webbox_port)"
export WEBBOX_PASSWORD="$(bashio::config webbox_password)"
export WEBBOX_POLL_INTERVAL="$(bashio::config webbox_poll_interval)"
export WEBBOX_DEVICE_KEY="$(bashio::config webbox_device_key)"
export WEBBOX_DEVICE_FILTER="$(bashio::config webbox_device_filter)"
export PUBLISH_WEBBOX="$(bashio::config publish_webbox)"
